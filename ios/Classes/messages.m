...
-(NSDictionary*)toMap;
@end
@interface FBPanGestureParams ()
+(FBPanGestureParams*)fromMap:(NSDictionary*)dict;
-(NSDictionary*)toMap;
@end
...
@implementation FBPanGestureParams
+(FBPanGestureParams*)fromMap:(NSDictionary*)dict {
  FBPanGestureParams* result = [[FBPanGestureParams alloc] init];
  result.uniqueId = dict[@"uniqueId"];
  if ((NSNull *)result.uniqueId == [NSNull null]) {
    result.uniqueId = nil;
  }
...
-(NSDictionary*)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.uniqueId ? self.uniqueId : [NSNull null]), @"uniqueId", (self.enable ? self.enable : [NSNull null]), @"enable", nil];
}
@end
...
- (void)onNativeViewShow:(FBCommonParams*)input completion:(void(^)(NSError* _Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.FlutterRouterApi.onNativeViewShow"
      binaryMessenger:self.binaryMessenger];
  NSDictionary* inputMap = [input toMap];
  [channel sendMessage:inputMap reply:^(id reply) {
    completion(nil);
...
- (void)onNativeViewHide:(FBCommonParams*)input completion:(void(^)(NSError* _Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.FlutterRouterApi.onNativeViewHide"
      binaryMessenger:self.binaryMessenger];
  NSDictionary* inputMap = [input toMap];
  [channel sendMessage:inputMap reply:^(id reply) {
    completion(nil);
...
void FBNativeRouterApiSetup(id<FlutterBinaryMessenger> binaryMessenger, id<FBNativeRouterApi> api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [FlutterBasicMessageChannel
        messageChannelWithName:@"dev.flutter.pigeon.NativeRouterApi.enablePanGesture"
        binaryMessenger:binaryMessenger];
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FBPanGestureParams *input = [FBPanGestureParams fromMap:message];
        FlutterError *error;
        [api enablePanGesture:input error:&error];
        callback(wrapResult(nil, error));
      }];
    }
    else {
